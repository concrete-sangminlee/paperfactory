...
TEMPLATES = {
    "ml_comparison": {
        ...
        "sections": [
            ...
            {"heading": "METHODOLOGY", "subsections": [
                {"heading": "Data description", "outline": ["Source, size, features, target variable"]},
                {"heading": "Feature engineering", "outline": ["Feature categories, extraction methods, normalization"]},
                {"heading": "ML models", "outline": ["Model architectures, hyperparameters, training details"]},
                {"heading": "Evaluation protocol", "outline": ["K-fold CV, metrics (R², RMSE, MAE or Accuracy, F1)"]},
            ]},
            {"heading": "RESULTS AND DISCUSSION", "subsections": [
                {"heading": "Overall performance comparison", "outline": ["Table + scatter plots"]},
                {"heading": "Feature importance analysis", "outline": ["Bar chart, physical interpretation"]},
                {"heading": "Comparison with existing studies", "outline": ["Literature comparison (3+ studies)"]},
                {"heading": "Error analysis", "outline": ["Residuals, Q-Q plot, parameter-dependent errors"]},
            ]},
            {"heading": "CONCLUSIONS", "outline": [
    ...
    "experimental": {
        ...
        "sections": [
            ...
            {"heading": "EXPERIMENTAL PROGRAM", "subsections": [
                {"heading": "Test specimens", "outline": ["Geometry, materials, fabrication"]},
                {"heading": "Test setup and instrumentation", "outline": ["Equipment, sensors, data acquisition"]},
                {"heading": "Loading protocol", "outline": ["Loading type, rate, sequence"]},
            ]},
            {"heading": "RESULTS", "subsections": [
                {"heading": "Observed behavior", "outline": ["Failure modes, crack patterns"]},
                {"heading": "Load-displacement response", "outline": ["Hysteresis curves, envelope curves"]},
                {"heading": "Strain distribution", "outline": ["Strain gauge data analysis"]},
            ]},
            {"heading": "DISCUSSION", "subsections": [
                {"heading": "Comparison with code predictions", "outline": ["ACI, ASCE, Eurocode comparison"]},
    ...
    "numerical": {
        ...
        "sections": [
            ...
            {"heading": "NUMERICAL MODEL", "subsections": [
                ...
                {"heading": "Boundary conditions and loading", "outline": ["Supports, loads, analysis type"]},
                {"heading": "Model validation", "outline": ["Comparison with experimental data"]},
            ]},
            {"heading": "PARAMETRIC STUDY", "subsections": [
                {"heading": "Parameters investigated", "outline": ["Variable ranges, analysis matrix"]},
                {"heading": "Results", "outline": ["Effect of each parameter"]},
            ]},
            {"heading": "DISCUSSION", "outline": [
    ...
    "review": {
        ...
        "sections": [
            ...
            {"heading": "CLASSIFICATION FRAMEWORK", "outline": [
                "Taxonomy of reviewed studies",
                "Classification criteria",
            ]},
            {"heading": "REVIEW OF METHODS", "subsections": [
                {"heading": "Category 1", "outline": ["Methods, key findings, strengths/limitations"]},
                {"heading": "Category 2", "outline": ["Methods, key findings, strengths/limitations"]},
                {"heading": "Category 3", "outline": ["Methods, key findings, strengths/limitations"]},
            ]},
            {"heading": "DISCUSSION", "subsections": [
                {"heading": "Comparative analysis", "outline": ["Performance comparison across categories"]},
                {"heading": "Research gaps", "outline": ["Identified gaps and unresolved challenges"]},
...
def generate_skeleton(template_key: str, topic: str = "", journal_key: str = "") -> dict:
    ...
    return {
        ...
        "sections": sections,
        "tables": [{"caption": f"[PLAN] {t}", "headers": [], "rows": []}
